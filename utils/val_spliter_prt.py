...
if __name__ == '__main__':
    fold = 4
    white_list = glob.glob("/home/abc/datasets/PolyDataset2/white_light/*/*.JPG")
    nbi_list = glob.glob("/home/abc/datasets/PolyDataset2/NBI/*/*.JPG")
...
# ------------------------- white begin --------------------------
    ...
    f = open('../splits/train_wht_prt%d.txt' % fold, 'w')
    f.write('\n'.join(train_wht_list))
    f = open('../splits/val_wht_prt%d.txt' % fold, 'w')
    f.write('\n'.join(val_wht_list))
