...
import numpy as np
from models.inc3 import inception_v3
from models.discriminator_inc3 import Discriminator
os.environ["CUDA_VISIBLE_DEVICES"] = "5"

def try_get_pretrained(teacher, student, raw_student, scratch):
    raw_stu_path = '../module/poly_raw_student_inc3.pth'
    tea_path = '../module/poly_teacher_inc3.pth'
    stu_path = '../module/poly_student_our_inc3.pth'
    dis_path = '../module/poly_discriminator_our_inc3.pth'
    if not scratch:
...
if __name__ == '__main__':
    ...
    raw_student = inception_v3(pretrained=True, num_classes=2).cuda()
